...
<div class="col-12">
    <div class="card mb-4">
      <div class="card-header"><strong>Site Pintasan footer</strong></div>
      <div class="card-body">
        <div class="example">
          ...
          <div class="tab-content rounded-bottom">
            <form action="{{route('pintasan-store')}}" method="post">
          @csrf
            <div class="tab-pane p-3 active preview">
              ...
              <div class="mb-3 col-4 itsmobile" data-menu-ids="{{$key->id}}">
                ...
                <div class="body" style="display: none" data-menu-ids="{{$key->id}}" >
                  ...
                  <div class="remove">
                    <a href="{{url('/')}}/pintasan/{{$key->id}}/remove" style="color:red" class="remove-menu">Remove</a>
                    <span>|</span>
...
$(document).ready(function() {
  ...
  $("#addmenus").click(function(e) {
    ...
    var newMenu = $('<div class="mb-3 col-4 itsmobile" id="menu' + i + '">' +
                      '<div class="head d-flex justify-content-between">' +
                        '<div class="head-left" id="head-left' + i + '"><b>Pintasan</b></div>' +
                        '<div class="head-right">' +
                          '<small>custom link</small>' +
