...
<div class="col-12">
    <div class="card mb-4">
      <div class="card-header"><strong>Google Analytics</strong></div>
      <div class="card-body">
        <div class="example">
            ...
            <div class="tab-pane p-3 active preview">
               <form action="{{route('analytics')}}" method="post">
                ...
                <div class="mb-3">
                  ...
                  <textarea class="form-control" name="analytics" id="exampleFormControlTextarea1" rows="5" required>@isset($analytics){{$analytics->body}}@endisset</textarea>
                </div>
