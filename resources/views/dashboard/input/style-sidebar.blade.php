...
<div class="col-12">
    <div class="card mb-4">
      <div class="card-header"><strong>Sidebar CSS</strong></div>
      <div class="card-body">
        <div class="example">
          ...
          <div class="tab-content rounded-bottom">
            <div class="tab-pane p-3 active preview">
               <form action="{{route('style-sidebar')}}" method="post">
                @csrf
                <div class="mb-3">
                  <label for="exampleFormControlTextarea1" class="form-label">Background color</label>
                  <input type="color" name="background" class="form-control form-control-color" id="exampleColorInput" 
                ...
                <div class="mb-3">
                  <label for="exampleFormControlTextarea1" class="form-label">Border color</label>
                  <input type="color" name="border" class="form-control form-control-color" id="exampleColorInput" 
                   title="Choose your color">
                </div>
