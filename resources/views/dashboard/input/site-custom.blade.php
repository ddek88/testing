...
<div class="col-12">
    <div class="card mb-4">
      <div class="card-header"><strong>Custom CSS</strong></div>
      <div class="card-body">
        <div class="example">
            ...
            <div class="tab-pane p-3 active preview">
               <form action="{{route('custom-store')}}" method="post">
                ...
                <div class="mb-3">
                  ...
                  <textarea class="form-control" name="custom" id="exampleFormControlTextarea1" rows="3" required>@isset($custom){{$custom->custom}}@endisset</textarea>
                </div>
