            ...
            <div class="tab-pane p-3 active preview">
                ...
                <div class="mb-5 mt-3">
                  <picture>
                    ...
                    @if(isset($image->background)) {{url('/')}}/{{$image->background}} @else {{url('/')}}/logo.png @endif" class="img-fluid img-thumbnail" alt="" width="200" height="100">
                ...
                <div class="mb-5 mt-3">
                  <picture>
                    ...
                    @if(isset($image->thumn)) {{url('/')}}/{{$image->thumn}} @else {{url('/')}}/logo.png @endif" class="img-fluid img-thumbnail" alt="" width="200" height="100">
                    ...
                    <input type="text" id="juks" name="itsssv" style="display: none">
                  </picture>
                  <small id="namaimages"></small>
                    <div class="mb-3 mt-4">
                        ...
                        @enderror
                        <input type="text" name="judul" value="{{old('judul')}}" class="form-control @error('judul')is-invalid @enderror" id="judul">
                      </div>
                ...
                <div class="input-group mb-3">
                  ...
                  <input type="text" name="slug" value="{{old('slug')}}" class="form-control  @error('slug')is-invalid @enderror" id="basic-url" aria-describedby="basic-addon3">
                ...
                <div class="mb-3">
                  ...
                  @error('artikel')
                        ...
                        <small class="text-danger">{{$message}}</small>
                  @enderror
                  <textarea class="form-control" name="artikel" id="editor" rows="30">{{old('artikel')}}</textarea>
                </div>
                ...
                <div class="right">
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="keyword" value="{{old('keyword')}}" id="keyword" rows="3"></textarea>
                      </div>
                      <div class="mb-3">
                        <label for="deskripsi" class="form-label">Deskripsi</label>
                        <textarea class="form-control" name="deskripsi" value="{{old('deskripsi')}}" id="deskripsi" rows="3"></textarea>
                      </div>
                      <div class="mb-3">
                        <label for="custom" class="form-label">Custom Meta</label>
                        <textarea class="form-control" name="custom" value="{{old('custom')}}" id="custom" rows="3"></textarea>
                      </div>
                </div>
