...
<div class="col-12">
    <div class="card mb-4">
      <div class="card-header"><strong>Publish Posts</strong></div>
      <div class="card-body">
        <div class="example">
          ...
          <div class="tab-content rounded-bottom">
            <div class="tab-pane p-3 active preview">
                <table class="table caption-top">
                    <caption>Posts of publish</caption>
                    <thead>
                      <tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a id="edit" class="btn btn-primary btn-sm mb-1" href="{{url('/')}}/dashboard/publish/{{$items->id}}">Edit</a>
                                <a id="hapus" class="btn btn-danger btn-sm text-white mb-1" href="{{url('/')}}/dashboard/publish/{{$items->id}}/hapus">Hapus</a>
                            </td>
                          </tr>
                        @endforeach
                        @endisset
